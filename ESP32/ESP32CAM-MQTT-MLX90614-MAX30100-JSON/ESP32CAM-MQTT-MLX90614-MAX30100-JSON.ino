...
const char* mqtt_server = "192.168.100.7"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"Omar\",\"temp\":"+String(random(18, 23))+",\"hum\":"+String(random (38,52))+"}";
